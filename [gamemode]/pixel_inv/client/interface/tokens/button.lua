...
function ButtonToken:init (x,y, w,h, text, color, opacity, action) 
  ...
  createRectangle(self.text, w, h, false, 0.05);
end
...
function ButtonToken:render (x, y, alpha) 
  ...
  dxDrawText(self.text, self.x, self.y, self.x + bgw, self.y + bgh, tocolor(255, 255, 255, alpha), 1.0, fonts.OutfitRegular96, "center", "center"); 
end