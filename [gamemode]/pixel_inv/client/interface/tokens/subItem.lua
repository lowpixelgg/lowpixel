SubItem = newclass "SubItem";

function SubItem:init (index, position, number, data, size)
  self.x = 0;
  self.y = 0;
  self.width = 0;
  self.height = 0;
...
function SubItem:design (x, y, alpha) 
...
function SubItem:render (position, alpha) 
  self.x = position.x;
  self.y = position.y;
