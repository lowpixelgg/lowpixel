...
function SVG:createRectangle (id, width, height)
    local raw = string.format([[
        <svg width="%s" height="%s" viewBox="0 0 %s %s" fill="none" >
        <rect width="%s" height="%s" rx="2" fill="#148242"/>
        </svg>        
...
function SVG:createBuy (id, width, height, rx, fillOpacity, strokeOpacity, sizeStroke)
    width = width or 1
    height = height or 1
    rx = rx or 2
